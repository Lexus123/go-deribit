...
// SubscribeTradesKind subscribes to the trades.{instrument_name}.{interval} channel
func (e *Exchange) SubscribeTradesKind(kind, currency, interval string) (chan *models.PublicTrade, error) {
	chans := []string{fmt.Sprintf("trades.%s.%s.%s", kind, currency, interval)}
